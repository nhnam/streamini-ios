    ...
    fileprivate func addHeartEffect(_ image: UIImageView) {
        ...
        UIView.animate(withDuration: 0.3, animations: { () -> Void in
            image.alpha = 1.0
                ...
                UIView.animate(withDuration: 3.0, delay: 2.0, options: UIViewAnimationOptions(), animations: { () -> Void in
                    image.alpha = 0.0
                    }, completion: { (finished) -> Void in
                    ...
                    image.center = CGPoint(x: image.center.x, y: y2) // rise
                        ...
                        UIView.animate(withDuration: 0.1, delay: 0.0, options: UIViewAnimationOptions.curveEaseOut, animations: { () -> Void in
                            image.center = CGPoint(x: image.center.x, y: y1) // fall
                                ...
                                UIView.animate(withDuration: 0.7, delay: 0.0, options: UIViewAnimationOptions(), animations: { () -> Void in
