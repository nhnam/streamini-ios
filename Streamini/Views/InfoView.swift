...
class InfoView: UIView {
    ...
    override func awakeFromNib() {
        ...
        shareButton.addTarget(self, action: #selector(InfoView.shareButtonPressed(_:)), for: UIControlEvents.touchUpInside)
        reportButton.addTarget(self, action: #selector(InfoView.reportButtonPressed(_:)), for: UIControlEvents.touchUpInside)
    }
